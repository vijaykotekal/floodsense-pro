...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Predict. Protect. Prepare. A demo command center for mountain flood risk and preparedness." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "FloodSense AI — Mountain Flood Early Warning System" },
      { property: "og:description", content: "Predict. Protect. Prepare. A demo command center for mountain flood risk and preparedness." },
